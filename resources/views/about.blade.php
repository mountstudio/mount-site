...
@section('content')
    ...
    <section class="breadcrumb-area bg-img bg-overlay jarallax" style="background-image: url(img/bg-img/kenny2.jpg);">
                    ...
                    <div class="breadcrumb-content text-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="{{ asset('/') }}"><i class="icon_house_alt"></i> Home</a></li>
